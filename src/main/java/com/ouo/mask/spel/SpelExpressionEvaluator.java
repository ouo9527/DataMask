...
public abstract class SpelExpressionEvaluator {
    ...
    public <R> R exe(String expression, Class<R> resultType, @Nullable EvaluationContext evalContext,
        ...
        if (exp instanceof PlaceholderExpression) {
            return ((PlaceholderExpression) exp).getValue(evalContext, resultType, fn);
        }

        return null == evalContext ? exp.getValue(resultType) : exp.getValue(evalContext, resultType);
    }
    ...
    public Object exe(String expression, @Nullable EvaluationContext evalContext,
                      @Nullable PlaceholderExpressionFunction<Object> fn) {
